...
class LevenbergMarquardt:
    ...
    def _cast_state(self, lm_state, dtype):
        # Shared-loop protocol hook: recast the carried scalars so the
        # while_loop carry matches what update() returns.
    ...
    def _cold_state(self, lm_state):
        # Shared-loop protocol hook for multi-start lane resets.
        return _cold_lm_state(lm_state)

    def _ranking_objective(self, result, p, callback):
        # Shared-loop protocol hook for multi-start selection.
        return _ranking_loss(self, result, p, callback)
